<h2 align="center"> #Problems</h2>
  ...
  <a href = "https://github.com/fadyat/ITMO-PUBLIC/blob/master/OS/III%20semester/Solutions/lab4/src1.sh">1.</a>
  Скрипт rmtrash
  ...
  <a href = "https://github.com/fadyat/ITMO-PUBLIC/blob/master/OS/III%20semester/Solutions/lab4/src2.sh">2.</a>
  Скрипт untrash
...
восстановить файл по указанному полному пути (создать в соответствующем каталоге жесткую ссылку на файл из trash и удалить
  ...
  <a href = "https://github.com/fadyat/ITMO-PUBLIC/blob/master/OS/III%20semester/Solutions/lab4/src3.sh">3.</a>
  Скрипт backup
...
<a href = "https://github.com/fadyat/ITMO-PUBLIC/blob/master/OS/III%20semester/Solutions/lab4/src4.sh">4.</a>
  Скрипт upback
