...
<div>
  <a href = "https://github.com/fadyat/ITMO-PUBLIC/blob/master/OS/III%20semester/Solutions/lab3/src1.sh">1.</a>
...
<div>
  <a href = "https://github.com/fadyat/ITMO-PUBLIC/blob/master/OS/III%20semester/Solutions/lab3/src2.sh">2.</a>
...
<div>
  <a href = "https://github.com/fadyat/ITMO-PUBLIC/blob/master/OS/III%20semester/Solutions/lab3/src3.sh">3.</a>
  Задайте запуск скрипта из пункта 1 в каждую пятую минут каждого часа в день недели, в который вы будете выполнять работу.
</div>  
<div>
  <a href = "https://github.com/fadyat/ITMO-PUBLIC/blob/master/OS/III%20semester/Solutions/lab3/src4.sh">4.</a>
...
<div>
  <a href = "https://github.com/fadyat/ITMO-PUBLIC/blob/master/OS/III%20semester/Solutions/lab3/src5.sh">5.</a>  
...
<div>
  <a href = "https://github.com/fadyat/ITMO-PUBLIC/blob/master/OS/III%20semester/Solutions/lab3/src6.sh">6.</a>
...
<div align=middle>
  <a href = "https://github.com/fadyat/ITMO-PUBLIC/tree/master/OS/III%20semester/Solutions/lab3/bulls%26cows"> TEST</a> |
    <a href = "https://github.com/fadyat/ITMO-PUBLIC/tree/master/OS/III%20semester/Solutions/lab3/tic_tac_toe"> TEST</a>
</div>
